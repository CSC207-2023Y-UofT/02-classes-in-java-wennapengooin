...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param first_string a String for the first part of this Silly instance's name.
     * @param second_string a String for the second part of this Silly instance's name.
     */
